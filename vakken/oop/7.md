...
public partial class Form1 : Form
{
    ...
    {
        InitializeComponent();
        Bewoner bewoner1 = new Bewoner("Janssens", "Maxim", 3, Verdiepen.Verdiep1);
        Bewoner bewoner2 = new DementerendeBewoner("Hendrickx", "Luka", 2);
        Bewoner bewoner3 = new Bewoner("Brangers", "Liam", 1);
